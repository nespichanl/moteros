...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-07-2019 a las 02:38:15
...
INSERT INTO `cliente` (`idcliente`, `placa`, `nombre`, `tel`, `marca`, `Cc`, `fecha`) VALUES
(1, 'YPW17D', 'Daniel Hernandez ', 2147483647, '------', 77095554, '2019-06-04'),
(2, '----------', 'Javier Castiblanco', 2147483647, '----------', 79535600, '2019-05-20');
...
(1, 'Motero Administrador', 'gelkin08@gmail.com', 'admin', '9593ab63f5b0b41dfbac3890230a6754', 1);
